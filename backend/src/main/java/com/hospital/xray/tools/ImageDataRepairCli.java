...
public class ImageDataRepairCli {
    public static void main(String[] args) {
        ...
        try {
            ...
            log.error("Error executing ImageDataRepairCli", e);
            exitCode = 1;
        } finally {
    ...
    static class Runner {
        ...
        private void repairImage(Long imageId) throws Exception {
            ...
            if (target == null) {
                log.info("[SKIP] image not found: {}", imageId);
                return;
            }
            ...
            log.info("[CHECK] imageId={} original={} thumbnail={} path={}", imageId, originalExists, thumbnailExists, target.getFilePath());
